...
(()=>{
 ...
 reportGame(r){f.reports.push(r);return Promise.resolve();},finish(r){f.finishes.push(r);const round=this.round;this.round++;this.playing=false;this.emit('result',{round,void:!!r.void,draw:!!r.draw,ranking:r.winner?[r.winner]:[]});return Promise.resolve();},
